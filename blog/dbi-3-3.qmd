...
For first-time users I recommend starting with the new [introductory tutorial](https://dbi.r-dbi.org/articles/DBI.html).
...
The [DBI specification](https://dbi.r-dbi.org/articles/spec.html) contains a detailed description of the methods provided by DBI.
...
The [introduction](https://dbi.r-dbi.org/articles/DBI.html) includes a walkthrough that describes connecting and querying a real database.
The ["Advanced DBI usage"](https://dbi.r-dbi.org/articles/DBI-advanced.html) tutorial shows more advanced examples of quoting and parameter binding.
...
As proposed in the [previous blog post](https://www.r-dbi.org/blog/dbi-3-2.html), new arguments `timezone` and `timezone_out` were added.
