...
The new implementation can build on the lessons learned from ODBC.
...
- bindings to the native database driver
...
- database meta-information
    ...
    - what is stored on the database?

- SQL generation

- utilities for common tasks

- utilities for tasks specific to the particular database

Responsibility of DBI as an implementer's interface:

- simple connect and disconnect based on credentials

- data type mapping between R and the native database driver
...
- Subscribe to the blog for yearly updates

- Try out the adbi package and provide feedback

- Watch the dbi3 repository for progress, and contribute to the discussion

    - Link to doc: how to watch GitHub repo, https://docs.github.com/en/account-and-profile/managing-subscriptions-and-notifications-on-github/setting-up-notifications/configuring-notifications#configuring-your-watch-settings-for-an-individual-repository
