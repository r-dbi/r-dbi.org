...
For users that are new to DBI, the [introductory tutorial](https://dbi.r-dbi.org/articles/DBI.html) provides a good entry point for getting acquainted with some key concepts.
...
Several packages associated with DBI have been updated since [early 2021](https://www.r-dbi.org/blog/dbi-3-3.html):
