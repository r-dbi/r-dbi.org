...
Users interact with DBMSes via the DBI package using an API that is common to all DBMSes.
...
The remainder of this article describes overall improvements, highlights changes to specific packages, and gives a glimpse on the new adbi package.
...
- All packages now use the new pkgdown documentation template at <https://github.com/r-dbi/dbitemplate>, and the website at <https://r-dbi.org> has been redesigned.
